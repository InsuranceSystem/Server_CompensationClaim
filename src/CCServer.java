...
public class CCServer extends UnicastRemoteObject implements CC_ServerIF {
	...
	}System.setProperty("java.security.policy","policy.txt");System.setSecurityManager(null);
	...
	Registry registry1 = LocateRegistry.createRegistry(1300);registry1.rebind("CarAccidentList",stub);

	// SurveyList 객체 등록
	SurveyList surveyList = new SurveyListImpl();
	SurveyList stub2 = (SurveyList) UnicastRemoteObject.exportObject(surveyList, 0);
	Registry registry2 = LocateRegistry.createRegistry(1301);registry2.rebind("SurveyList",stub2);
	...
	Registry registry3 = LocateRegistry.createRegistry(1302);registry3.rebind("CompensationClaimList",stub3);
